...
# date: 13.10.2017; 
# edited: 09.05.2018; edited 23.05.2018, edited for PT 08.06.2018
# edited: 16.01.2019
# create phenotype input files for BGENIE (which do not have sample IDs, and need to match the order within the BGEN file)# genetic data: v3; imputed data, 
...
#        "10",
#        "ukb25465_ukb25468",# "ukb21288_ukb21293",
#        "imagingT1_N18057", #"imagingT1_N12245",
#        "females")
...
#------------------------------------
  # define files
  pheno_imaging_file<-paste(imaging_dir,list.files(imaging_dir,pattern=paste("imaging",covs_name,"_",region,"_",sex,"_Phenotypes_residuals_wHeader.table",sep="")),sep="")
  out_file=paste(out_dir,pheno_root,"_",type,"_sample_",subset_name,"_",region,"_",sex,"_phenos4BGENIE.table",sep="")
  #  read data
  ...
  if (file.exists(out_file2)==FALSE){
      ...
      pheno_samples<-pheno_samples[,c("ID_1",phenos)]
