function [ peak, clus, clusid, clusid_vrtx ] = mySurfStatPeakClus( slm, mask, thresh, ...
    reselspvert, edg )
...
[cl, index]=sortrows([rankrsl' ucvol' ucrsl'],1);
 
clusid_vrtx=clusid_vrtx(index);
